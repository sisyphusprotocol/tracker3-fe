  ...
  return (
    <div className={classes}>
      <input
        ...
        ref={inputRef}
        placeholder={
          props.placeHolder ? props.placeHolder : DEFAULT_PLACEHOLDER
        }
        defaultValue={
          props.defaultContent ? props.defaultContent : DEFAULT_CONTENT
        }
      />
      <div className={style.search} onClick={() => props.onSearch(inputRef)}>
        <Image className="" width="20" height="20" src={_Search} alt="search"></Image>
      </div>
    </div>
  );
}
